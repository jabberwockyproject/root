...
public class MainActivity extends Activity implements View.OnClickListener,View.OnLongClickListener,AdapterView.OnItemClickListener,AdapterView.OnItemLongClickListener {
    ...
    private class SoundInitThread implements Runnable {
        ...
        public void run() {
            ...
            soundArray[14] = new Sound("Craché beaucoup",R.raw.crache_beaucoup);
            ...
            soundArray[27] = new Sound("Intéresse pas",R.raw.interesse_pas);
            ...
            soundArray[34] = new Sound("Me sens tellement seul",R.raw.me_sens_seul);
            ...
            soundArray[40] = new Sound("Nouveauté",R.raw.nouveaute);
            ...
            soundArray[45] = new Sound("Pas Drôle",R.raw.pas_drole);
            ...
            soundArray[55] = new Sound("Préjudice",R.raw.prejudice);
            soundArray[56] = new Sound("Prévoyant",R.raw.prevoyant);
            ...
            soundArray[62] = new Sound("En quelque sorte",R.raw.quelque_sorte);
            ...
            soundArray[67] = new Sound("Santé",R.raw.sante);
            ...
            soundArray[72] = new Sound("Triple épaisseur",R.raw.triple_epaisseur);
            ...
            soundArray[83] = new Sound("Tout à fait",R.raw.tout_a_fait);
            ...
            soundArray[90] = new Sound("Pas nécessaire",R.raw.pas_necessaire);
            soundArray[91] = new Sound("Ben oui",R.raw.ben_oui);
            soundArray[92] = new Sound("Trop risqué",R.raw.trop_risque);
            ...
            soundArray[97] = new Sound("Céder le passage",R.raw.ceder_le_passage);
            soundArray[98] = new Sound("Demi tour",R.raw.demi_tour);
            soundArray[99] = new Sound("Devenir une saveur inédite",R.raw.devenir_saveur_inedite);
            soundArray[100] = new Sound("Dos d'âne",R.raw.dos_d_ane);
            soundArray[101] = new Sound("Impressionant",R.raw.impressionant);
            soundArray[102] = new Sound("Le saviez vous",R.raw.le_saviez_vous);
            soundArray[103] = new Sound("Priorité à droite",R.raw.priorite_a_droite);
